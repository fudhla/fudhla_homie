...
import { FaArrowLeft, FaCheck, FaUser, FaSparkles, FaNotesMedical } from "react-icons/fa";
  ...
  return (
    <div className="p-6 bg-[#061A2B] min-h-screen text-white font-sans">
      ...
      <div className="max-w-2xl bg-[#133C5E] p-8 rounded-3xl border border-white/5 shadow-2xl">
        ...
        {step === 2 && (
          <div className="space-y-6 animate-fadeIn">
            <h3 className="text-lg font-bold text-[#31B296] flex items-center gap-2"><FaSparkles size={16}/> Tipe Kulit & Usia</h3>
