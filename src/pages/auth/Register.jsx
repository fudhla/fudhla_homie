...
export default function Register() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: "",
    password: "",
    role: isAdminRegistration ? "admin" : "member",
    tier: "Bronze",
    points: 0,
  });
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 px-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full">
        ...
        <p className="text-sm text-center text-slate-500 mb-3">
          {isAdminRegistration ? "Registrasi Administrator" : "Daftar Akun Keanggotaan Baru"}
        </p>
        {isAdminRegistration && (
          <div className="mb-6 px-4 py-2 bg-rose-50 border border-rose-200 rounded-xl flex items-center justify-center gap-2">
            <span className="text-[10px] font-black text-rose-600 uppercase tracking-widest">🔒 Mode Admin</span>
          </div>
        )}
